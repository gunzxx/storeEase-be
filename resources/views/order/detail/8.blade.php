...
@section('content')
    ...
    <div class="detail-order-container">
        ...
        <div class="side right-side">
            ...
            <a href="/order/{{ $order->uuid }}/new-document" class="order-action">Unggah Dokumen LAPORAN AKHIR</a>
            <a href="/order/{{ $order->uuid }}/to9" class="next-button">
                <p>Penutupan Pesanan</p>
                <p>--SELESAI--</p>
            </a>
        </div>
    </div>
