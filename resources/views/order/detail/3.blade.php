...
@section('content')
    ...
    <div class="detail-order-container">
        ...
        <div class="side right-side">
            ...
            <a href="/order/{{ $order->uuid }}/down_payment" class="order-action">Unggah File Invoice Down Payment</a>
            <a href="/order/{{ $order->uuid }}/invoice/down_payment" class="order-action">Unggah Bukti Transaksi</a>
            <a href="/order/{{ $order->uuid }}/to4" class="next-button">Lanjut ke tahap PERSIAPAN AWAL</a>
        </div>
    </div>
@endsection
