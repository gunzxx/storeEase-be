...
@section('content')
    ...
    <div class="detail-order-container">
        ...
        <div class="side right-side">
            ...
            <a href="/order/{{ $order->uuid }}/job-desk/{{ $jobDesk->id }}" class="order-action">Buat Daftar Kerja Persiapan Akhir Untuk Monitor</a>
            <a href="/order/{{ $order->uuid }}/to7" class="next-button">Lanjut ke tahap PERNIKAHAN</a>
        </div>
    </div>
@endsection
